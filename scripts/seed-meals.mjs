...
const MENU = [
  ...
  // =========================================================================
  {
    ...
    ingredients: [
      ...
      { name: 'Garlic',                     quantity: 200,  unit: 'g',      prep: 'on-site',  kcal: 1.49 },
      { name: 'Crushed tomatoes',           quantity: 5,    unit: 'kg',     prep: 'on-site',  kcal: 160  },
      { name: 'Eggs',                       quantity: 30,   unit: 'pieces', prep: 'on-site',  kcal: 78   },
      { name: 'Paprika',                    quantity: 80,   unit: 'g',      prep: 'on-site',  kcal: 2.82 },
      { name: 'Cilantro',                   quantity: 200,  unit: 'g',      prep: 'on-site',  kcal: 0.23 },
      { name: 'Parsley',                    quantity: 200,  unit: 'g',      prep: 'on-site',  kcal: 0.36 },
      ...
      { name: 'Liquid smoke',               quantity: 100,  unit: 'ml',     prep: 'on-site',  kcal: 0.02 },
      { name: 'Olive oil',                  quantity: 500,  unit: 'ml',     prep: 'on-site',  kcal: 8.8  },
...
NOW REFLESH BELOW -18°C MOTHERFUCKER ! (I should be an insulting freezer)`,
    ...
    ingredients: [
      ...
      { name: 'Cilantro',              quantity: 200,  unit: 'g',   prep: 'on-site',  kcal: 0.23 },
      { name: 'Red curry paste',       quantity: 500,  unit: 'g',   prep: 'on-site',  kcal: 1.6  },
      { name: 'Mango chutney',         quantity: 1,    unit: 'kg',  prep: 'on-site',  kcal: 2500 },
      { name: 'Liquid smoke',          quantity: 80,   unit: 'ml',  prep: 'on-site',  kcal: 0.02 },
      ...
      { name: 'Olive oil',             quantity: 400,  unit: 'ml',  prep: 'on-site',  kcal: 8.8  },
    ],
  },
...
If it's not good, you can pay me a direct flight from Bolivia, I come, I slap all your asses, I show you how to do it, then I eat, then you do it again.`,
    ...
    ingredients: [
      ...
      { name: 'Dill',                    quantity: 150,  unit: 'g',      prep: 'on-site',  kcal: 0.43 },
      ...
      { name: 'Paprika',                quantity: 50,   unit: 'g',      prep: 'on-site',  kcal: 2.82 },
      { name: 'Cumin',                  quantity: 50,   unit: 'g',      prep: 'on-site',  kcal: 3.75 },
...
NOW CONTINUE THE SAME WAY YOU DID FOR THE OTHER MARINATED CHICKED AND PUT IT IN THE CORPSE BOX.`,
    ...
    ingredients: [
      ...
      { name: 'Cinnamon',               quantity: 50,   unit: 'g',   prep: 'on-site',  kcal: 2.47 },
      { name: 'Marinated chicken',      quantity: 5,    unit: 'kg',  prep: 'pre-cook', kcal: 1650 },
      { name: 'Harissa sauce',          quantity: 700,  unit: 'g',   prep: 'on-site',  kcal: 0.9  },
      ...
      { name: 'Garlic',                 quantity: 150,  unit: 'g',   prep: 'on-site',  kcal: 1.49 },
      { name: 'Turmeric',               quantity: 50,   unit: 'g',   prep: 'on-site',  kcal: 3.54 },
      { name: 'Olive oil',              quantity: 500,  unit: 'ml',  prep: 'on-site',  kcal: 8.8  },
    ],
  },
...
Now cook the meat until it has the texture of a shoe AND FRIZE IT NICELY SENORITA.`,
    ...
    ingredients: [
      ...
      { name: 'Vegan – mushrooms',                  quantity: 800,  unit: 'g',      prep: 'pre-cook', kcal: 0.22 },
      { name: 'Vegan – red onions',                 quantity: 3,    unit: 'pieces', prep: 'pre-cook', kcal: 40   },
      { name: 'Vegan – green olives',               quantity: 400,  unit: 'g',      prep: 'on-site',  kcal: 1.45 },
      ...
      { name: 'Meatlovers – oregano',               quantity: 3,    unit: 'tbsp',   prep: 'on-site',  kcal: 8    },
      // 4 formaggi
      { name: '4 formaggi – sour cream',            quantity: 600,  unit: 'g',      prep: 'on-site',  kcal: 2.0  },
      { name: '4 formaggi – mozzarella',            quantity: 1.2,  unit: 'kg',     prep: 'on-site',  kcal: 2800 },
      { name: '4 formaggi – Roquefort',             quantity: 400,  unit: 'g',      prep: 'on-site',  kcal: 3.53 },
      { name: '4 formaggi – Parmigiano',            quantity: 500,  unit: 'g',      prep: 'on-site',  kcal: 4.31 },
      { name: '4 formaggi – Emmental',              quantity: 700,  unit: 'g',      prep: 'on-site',  kcal: 3.8  },
    ],
  },
  ...
  // =========================================================================
  {
    ...
    ingredients: [
      ...
      { name: 'Curry powder',               quantity: 40,  unit: 'g',      prep: 'on-site',  kcal: 3.25 },
  ...
  // =========================================================================
  {
    ...
    ingredients: [
      ...
      { name: 'Olive oil',   quantity: 300,  unit: 'ml',  prep: 'on-site', kcal: 8.8  },
    ],
  },
